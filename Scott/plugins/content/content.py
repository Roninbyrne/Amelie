...
class InRegistrationFlow(filters.Filter):
    ...
    async def __call__(self, client, message):
        ...
        return session and session.get("step") in [
            "name",
            "email",
            "otp",
            "ask_channels",
...
in_registration_flow = InRegistrationFlow()
...
@app.on_message(filters.private & filters.text & ~filters.command([""]) & in_registration_flow)
